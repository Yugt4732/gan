...
class discriminator_cnn(nn.Module):
    def __init__(self):
        ...
        self.conv2=    nn.Conv2d(64, 256, 4, 2, padding=1)
...
class generator(nn.Module):
    def __init__(self):
        super().__init__()
        self.conv1 = nn.ConvTranspose2d(128, 512, 4, 1, 0)
        ...
        # nn.Linear(256, 256),
        # nn.ReLU(True)
        self.conv3 = nn.ConvTranspose2d(256, 64, 4, 2, 1)
        self.conv4 = nn.ConvTranspose2d(64, 3, 4, 2, padding=1)
...
##
# G=generator(28)
dic = torch.load('./discriminator.pth')
print('dic = \n', dic)
D.load_state_dict(dic)
...
for epoch in range(num_epoch):
    ...
    for i, (img, _) in enumerate(dataloader):
        ...
        if epoch ==0:
            ...
            save_image(real_imgs, './img/real_imgs.png')
    fake_imgs = to_img(fake_img.cpu().data)
    save_image(fake_imgs, './img/fake_imgs-{}.png'.format(epoch+1))
